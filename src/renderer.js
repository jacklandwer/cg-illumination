...
class Renderer {
    constructor(canvas, engine, material_callback, ground_mesh_callback) {
        ...
        this.scenes = [
            ...
            {
                scene: new Scene(this.engine),
                background_color: new Color4(0.15, 0.15, 0.15, 1.0),
                materials: null,
                ground_subdivisions: [50, 50],
                ground_mesh: null,
                camera: null,
                ambient: new Color3(0.25, 0.25, 0.25),
                lights: [],
                models: []
            },
        ];
    ...
    createScene0(scene_idx) {
        ...
        scene.onKeyboardObservable.add((keypress) => {
            if (this.scenes[this.active_scene].scene.uid === scene.uid && keypress.type === KeyboardEventTypes.KEYDOWN) {
    ...
    createScene1(scene_idx) {
        ...
        // Create ground mesh
        let white_texture = RawTexture.CreateRGBTexture(new Uint8Array([255, 255, 255]), 1, 1, scene);
        let ground_heightmap = new Texture(BASE_URL + 'heightmaps/heightmap2.png', scene);
    ...
    createScene2(scene_idx) {
        ...
        // Create ground mesh
        let white_texture = RawTexture.CreateRGBTexture(new Uint8Array([255, 255, 255]), 1, 1, scene);
        let ground_heightmap = new Texture(BASE_URL + 'heightmaps/heightmap-modified.png', scene);
        ground_mesh.scaling = new Vector3(20.0, 1.0, 20.0);
        ground_mesh.metadata = {
        ...
        sphere.metadata = {
            mat_color: new Color3(0.9, 0.7, 0.0),
            mat_texture: white_texture,
            mat_specular: new Color3(0.8, 0.8, 0.8),
            mat_shininess: 8,
            texture_scale: new Vector2(1.0, 1.0),
        ...
        let positions = [
            ...
            6,
            0,
            2, // vertex 0 (Back right)
            4,
            0,
            2, // vertex 1 (Back left)
            4,
            0,
            -2, // vertex 2 (Front left)
            6,
            0,
            -2, // vertex 3 (Front right)
        ...
        donut.metadata = {
            mat_color: new Color3(0.0, 0.7, 0.5),
            mat_texture: white_texture,
            mat_specular: new Color3(0.8, 0.8, 0.8),
            mat_shininess: 4,
            texture_scale: new Vector2(1.0, 1.0),
    ...
    createScene3(scene_idx) {
        ...
        // Create ground mesh
        let white_texture = RawTexture.CreateRGBTexture(new Uint8Array([255, 255, 255]), 1, 1, scene);
        let ground_heightmap = new Texture(BASE_URL + 'heightmaps/heightmap3.png', scene);
        ground_mesh.scaling = new Vector3(20.0, 1.0, 20.0);
        ground_mesh.metadata = {
            mat_color: new Color3(0.20, 0.30, 0.25),
            mat_texture: white_texture,
            mat_specular: new Color3(0.0, 0.0, 0.0),
            mat_shininess: 1,
            texture_scale: new Vector2(1.0, 1.0),
        ...
        let sphere2 = CreateSphere('sphere', { segments: 42 }, scene);
        sphere2.position = new Vector3(-4.2, 3.95, -4.0);
        sphere2.metadata = {
            mat_color: new Color3(0.6, 0.23, 0.68),
            mat_texture: white_texture,
            mat_specular: new Color3(0.8, 0.8, 0.8),
            mat_shininess: 2,
            texture_scale: new Vector2(1.0, 1.0),
        ...
        let polyhedron = CreatePolyhedron('polyhedron', { radius: 2 }, scene);
        polyhedron.position = new Vector3(-3.45, 2.1, -3.4);
        polyhedron.metadata = {
            mat_color: new Color3(2.2, 0.3, 0.4),
            mat_texture: white_texture,
            mat_specular: new Color3(0.1, 0.1, 0.1),
            mat_shininess: 12,
            texture_scale: new Vector2(1.0, 1.0),
        ...
        let box = CreateBox('box', { width: 2, height: 1, depth: 1 }, scene);
        box.position = new Vector3(-1.0, 1.2, 3.5);
        box.metadata = {
            mat_color: new Color3(0.75, 0.25, 0.95),
            mat_texture: white_texture,
            mat_specular: new Color3(0.4, 0.4, 0.4),
